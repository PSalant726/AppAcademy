...
describe Array do
  ...
  describe "#my_transpose" do
    ...
    it "transposes a rectangular matrix with more columns than rows" do
      expect(large_rect_arr.my_transpose).to eq([
        [0, 4, 8, 2, 6, 0, 4],
        [1, 5, 9, 3, 7, 1, 5],
        [2, 6, 0, 4, 8, 2, 6],
        [3, 7, 1, 5, 9, 4, 8]
    ...
    it "transposes a rectangular matrix with more rows than colums" do
