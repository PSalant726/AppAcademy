...
describe String do
  describe "#caesar" do
    ...
    it "encodes a word containing capital and lowecase letters" do
      expect("AbZz".caesar(2)).to eq("CdBb")
    end
    
    it "encodes strings containing spaces" do
      expect("The Human Torch was denied a bank loan".caesar(3)).to eq("Wkh Kxpdq Wrufk zdv ghqlhg d edqn ordq")
    end
  end
end
...
describe Fixnum do
  describe "#stringify" do
    ...
    it "stringifies numbers in base 16" do
      ...
      expect(256134545.stringify(16)).to eq("f444d91")
    end
  end
end
